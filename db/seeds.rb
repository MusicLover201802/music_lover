...
# メンバーへ：下記は削除しないでください（開発中にこれらのテストデータを復元・追加する場面が想定されるため）フカイ
	...
	Disc.create(disc_name: '藤岡弘、ザ・ベスト[Disk1]', disc_num: '1', item_id: '1')
	Disc.create(disc_name: '藤岡弘、ザ・ベスト[Disk2]', disc_num: '2', item_id: '1')
	...
	Item.create(item_name: '藤岡弘、ザ・ベスト', artist_name: '藤岡弘、', artist_name_kana: 'フジオカヒロシ、', genre_id: '1', price: '3000', label_name: '昭和レコード', stock: '10', release_date: '20180331', purchase_flag: 'false', admin_id: '1')
	Item.create(item_name: 'モーニング娘。ザ・ベスト', artist_name: 'モーニング娘。', artist_name_kana: 'モーニングムスメ。', genre_id: '2', price: '2500', label_name: 'ハロープロジェクト', stock: '10', release_date: '20180311', purchase_flag: 'true', admin_id: '1')
	Item.create(item_name: 'はっぴぃえんど[Single]', artist_name: 'はっぴぃえんど', artist_name_kana: 'ハッピィエンド', genre_id: '3', price: '2000', label_name: 'Sony', stock: '10', release_date: '20180310', purchase_flag: 'true', admin_id: '1')
	Item.create(item_name: 'To Pinp A Butterfly', artist_name: 'Kendrick Lamar', artist_name_kana: 'ケンドリックラマー', genre_id: '4', price: '3000', label_name: 'AfterMath', stock: '10', release_date: '20170531', purchase_flag: 'true', admin_id: '1')
	...
	Track.create(disc_id: '1',track_name:'美味しいコーヒーを入れたいんだ',track_num: '1')
	...
	Track.create(disc_id: '5',track_name:'Alright',track_num: '1')
	Track.create(disc_id: '6',track_name:'How Much Dollar Costs',track_num: '2')
