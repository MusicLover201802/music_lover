...
Item.create(item_name: '藤岡弘、ザ・ベスト[2枚組]', artist_name: '藤岡弘、', artist_name_kana: 'フジオカヒロシ、', genre_id: '1', price: '3000', label_name: '昭和レコード', stock: '10', release_date: '20180331', purchase_flag: 'false', admin_id: '1')
...
Track.create(disc_id: '1',track_name:'藤岡、怒りの百烈ライダーキックで若輩ライダーに喝！！',track_num: '2')
